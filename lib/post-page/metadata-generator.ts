...
export async function generateBlogPostMetadata({
	...
	const canonicalString = `/blog/${slug}`;
	...
	const twitter_creator = postDetails.authorReference.twitterCreator ?? '@permit_io';
	const shouldIndex = postDetails.isHidden === null ? true : !postDetails.isHidden;
